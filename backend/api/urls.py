...
urlpatterns = [
    ...
    path('teacher/courses/<int:course_id>/topics/<int:topic_id>/quiz/get/', views.get_quiz, name='get-quiz'),
    path('teacher/courses/<int:course_id>/detail/', views.get_teacher_course_detail, name='teacher-course-detail'),
    path('courses/<int:course_id>/topics/<int:topic_id>/quiz/get/', views.get_quiz, name='student-get-quiz'),
