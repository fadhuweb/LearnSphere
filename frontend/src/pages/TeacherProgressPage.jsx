                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center">
                        <div className="w-full bg-gray-200 rounded-full h-2.5">
                          <div 
                            className={`h-2.5 rounded-full ${getProgressColor(student.total_progress)}`} 
                      ...
                      <div className="text-xs text-gray-500 mt-1">
                        {student.total_topics > 0 
                          ? `${Math.round(student.total_progress / 100 * student.total_topics)} of ${student.total_topics} topics completed`
                          : 'No topics available'}
                      </div>
                    </td>
                    <td className="px-6 py-4">
